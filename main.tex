...
Let $\theta_{-i}$ denote all the vector components of $\theta$ except $\theta_i$. Then, the \textbf{profile likelihood}(PLL) for $\theta_i$ is defoned as 
...
\begin{theorem}For large $n$, under suitable regularity conditions, we have the ``profile deviance":
